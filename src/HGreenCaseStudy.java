 ...
 * Date: August 2011
 */
public class HGreenCaseStudy extends GridSim {
	...
	public HGreenCaseStudy(String name, int numberOfResources) throws Exception {
		super(name, 9600);
		this.name = name;
	...
	public static void main(String[] args) {
		try 
		{
	        ...
	        HGreenCaseStudy cs1 = new HGreenCaseStudy("HGreenCaseStudy", 6);
