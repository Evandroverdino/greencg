 ...
 * Date: August 2011
 */
public class RandomCaseStudy extends GridSim {
	...
	public RandomCaseStudy(String name, int numberOfResources) throws Exception {
		super(name, 9600);
		this.name = name;
	...
	public static void main(String[] args) {
		try 
		{
	        ...
	        System.out.println("Initializing Green GridSim Simulation");
	        ...
	        RandomCaseStudy cs1 = new RandomCaseStudy("RandomCaseStudy", 6);
    ...
    private void printResourceCosts()
    {
    	...
    	System.out.println("Energy Consumption Total: " + Math.round(energyConsumptionTotal));
